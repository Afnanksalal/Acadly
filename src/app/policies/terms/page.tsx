        ...
        <CardContent className="p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              By accessing and using Acadly, you accept and agree to be bound by the terms and provision of this agreement.
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              ...
              Acadly is not responsible for the quality, safety, or legality of items listed.
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Payment processing is handled through Razorpay. Acadly may charge service fees for transactions.
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Acadly is provided &quot;as is&quot; without warranties of any kind. We are not liable for any damages arising from
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              For questions about these terms, contact us at <a href="mailto:support@acadly.in" className="text-primary underline">support@acadly.in</a>
            </p>
          </section>
        </CardContent>
      </Card>
