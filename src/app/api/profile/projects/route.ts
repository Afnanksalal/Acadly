...
const projectSchema = z.object({
  ...
  githubUrl: z.string().url().optional().nullable().or(z.literal("")).transform(val => val || null),
  liveUrl: z.string().url().optional().nullable().or(z.literal("")).transform(val => val || null),
  imageUrls: z.array(z.string().url()).optional().default([]),
  startDate: z.string().datetime().optional().nullable().or(z.literal("")).transform(val => val || null),
  endDate: z.string().datetime().optional().nullable().or(z.literal("")).transform(val => val || null),
